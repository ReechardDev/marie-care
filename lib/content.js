...
// lib/content.js (append or create if missing)
export const TESTIMONIALS = [
  ...
  {
    quote:
      "Her experience with hospice made a difficult time much easier. Robin guided us with compassion and practical support.",
    author: "K.R.",
  ...
  {
    quote:
      "She listens first and builds a plan that actually fits our routines. We trust Robin completely.",
    author: "T.B.",
    location: "Aurora, CO",
    image: "",
  },
  {
    quote:
      "Professional and kind. Robin’s check-ins and updates gave our family real peace of mind.",
    author: "N.P.",
