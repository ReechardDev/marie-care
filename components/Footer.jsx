...
export default function Footer() {
  return (
    <footer className="border-t bg-card mt-10">
      <div className="mx-auto max-w-6xl px-4 py-10 grid gap-8 md:grid-cols-3 items-start text-center md:text-left">
        {/* Business info */}
        <div className="space-y-2">
          <div className="font-semibold">{SITE.name}</div>
          <div className="text-sm">Phone: {SITE.phoneDisplay}</div>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2 text-sm">
            ...
            <li>
              <Link href="/care-plans" className="hover:underline">
                Care Plans & Pricing
              </Link>
            </li>
            <li>
